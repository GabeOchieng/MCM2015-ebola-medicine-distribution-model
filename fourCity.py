...
vaccinePumpAmount = 100 * 4 #In doses
medsPumpTime = 5           #In days
medsPumpAmount = 1000 * 4       #In doses (all will be split amongst hubs!)
medsEffectiveness = 5 
initVaccinesPerRegion = [0,0,0,0] #Array, #vaccines/region
initMedsPerRegion = [0,0,0,0]  #Array, #meds/region

#Population parameters
percentBeginLatent = [0.05, 0.05, 0.05, 0.05]    #Percent that start in latent state
...
#Create regions
regions = []
paramsLists = [SierraParams, LiberiaParams, LiberiaParams, SierraParams]    #Array of arrays of parameters
...
regionVaccineShippingPercentage = [0.0,0.5,0.0,0.5]
regionMedsShippingPercentage = [0.0,0.5,0.0,0.5]
